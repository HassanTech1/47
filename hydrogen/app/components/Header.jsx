...
import { Search, User, ShoppingCart, Menu, Instagram } from 'lucide-react';
...
const Header = ({ onOpenAuth, onOpenSearch, onOpenAccount }) => {
  ...
  const showExpandedMenu = scrolled;
  ...
  return (
    <>
      ...
      >
        <span>
          Free delivery for orders above <span style={{ color: 'green' }}>475</span> SAR
        </span>
      </div>
      ...
      <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
        <SheetContent
          side="right"
          className="w-[300px] sm:w-[400px] bg-white text-black p-0 border-l border-gray-200"
        >
          <div className="flex flex-col h-full">
            ...
            <div className="p-6 border-t border-gray-100 bg-gray-50/50">
              <div className="space-y-6">
                <button
                  onClick={handleUserClick}
                  className="flex items-center gap-3 text-sm hover:text-gray-600 transition-colors w-full"
                >
