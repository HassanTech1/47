    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold tracking-wider uppercase">New Arrivals</h2>
        </div>
            ...
            >
              <div className="relative h-64 lg:h-96 overflow-hidden bg-gray-50 mb-4 flex items-center justify-center">
                ...
                <div className="absolute top-4 left-4">
                  <span className="text-xs text-gray-600 tracking-wider">{product.badge}</span>
                </div>
              </div>
